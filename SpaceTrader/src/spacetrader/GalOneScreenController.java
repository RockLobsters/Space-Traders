...
public class GalOneScreenController implements Initializable {
     ...
     */
    @FXML
    private static transient ImageView peachtreePlan;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView gastatePLan;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView gatechPlan;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView poncePlan;
     ...
     */
    private static final SolarSystem SOLAR = UNIVERSE.get(0);
    /**
    ...
    */
    ...
    planet = planets.get(THREE);
    poncePlan.setX(planet.getCoordinateX());
    poncePlan.setY(planet.getCoordinateY());
    }

    /**
     * Goes to the Peachtree planet when planet image is clicked on.
     *
     * @param event
    ...
    /**
     * Goes to the GaState planet when planet image is clicked on.
     *
     * @param event
     *            occurs when the user clicks on the planet
     * @throws  Exception
    ...
    /**
     * Goes to the GaTech planet when planet image is clicked on.
     *
     * @param event
     *            occurs when the user clicks on the planet
     * @throws  Exception
    ...
    /**
     * Goes to the Ponce planet when planet image is clicked on.
     *
     * @param event
     *            occurs when the user clicks on the planet
     * @throws  Exception
    ...
    if (SHIP.getFuel() > 0) {
        ...
        SHIP.setFuel(SHIP.getFuel() - 1);
        PLAYER.setCurrentLocation(SOLAR.getPlanets().get(THREE));
