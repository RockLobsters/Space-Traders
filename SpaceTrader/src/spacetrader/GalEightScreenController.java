 ...
 */
public class GalEightScreenController implements Initializable {
     ...
     * location of planet.
     */
    private static final transient int SOLARSYSTEMEIGHT = 7;

    /**
     * holds solar system.
     */
    private final transient SolarSystem solar = UNIVERSE.get(SOLARSYSTEMEIGHT);
    /**
    ...
    */
    ...
    private void goToPeacePlan(final MouseEvent event) throws Exception {
        if (SHIP.getFuel() > 0) {
            ...
            SHIP.setFuel(SHIP.getFuel() - 1);
            PLAYER.setCurrentLocation(solar.getPlanets().get(1 + 2));
    ...
    private String randEvent() {
        ...
        // String string = "";
            ...
            if (val == ((2 ^ 2) ^ 2)) {
                ...
                string = "Your fuel tank has a "
                        + "hole in it and some spilled out!";
                SHIP.setFuel(SHIP.getFuel() - 1);
            } else if (val == (((2 ^ 2) ^ 2) + 1)) {
