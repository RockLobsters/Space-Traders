...
public class GalTwoScreenController implements Initializable {
     ...
     */
    @FXML
    private static transient ImageView elsinor;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView scottish;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView verona;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView titus;
    /**
     * Shows fuel left.
     */
    @FXML
   ...
   /**
     ...
     */
    private static final SolarSystem SOLAR = UNIVERSE.get(1);
