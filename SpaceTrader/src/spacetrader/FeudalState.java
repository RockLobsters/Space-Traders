 ...
 */
public class FeudalState extends PoliticalSystem implements Serializable{
    ...
    public ArrayList<Good> supply() {
       ...
       availableSupply.add(new Good(GoodType.MACHINES, rand.nextInt(100) * 1));
       availableSupply.add(new Good(GoodType.NARCOTICS, rand.nextInt(100) * 100));
       availableSupply.add(new Good(GoodType.ROBOTS, rand.nextInt(100) * 1));
