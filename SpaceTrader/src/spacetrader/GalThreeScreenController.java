...
public class GalThreeScreenController implements Initializable {
     ...
     */
    private static final SolarSystem SOLAR = UNIVERSE.get(2);
    ...
    */
     ...
     */
    @FXML
    private static transient ImageView asmio;
    /**
     * Image for planet.
     */
    @FXML
     ...
     * Image for planet.
     */
    private static transient ImageView pohl;
    /**
     * Image for planet.
     */
    @FXML
    private static transient ImageView heinLein;
    /**
     * Tab for fuel.
     */
    @FXML
