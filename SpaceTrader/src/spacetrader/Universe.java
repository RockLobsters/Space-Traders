...
public class Universe extends ArrayList<SolarSystem> implements Serializable {
    ...
    public void bigBang() {
        ...
        SolarSystem aSystem = new SolarSystem("Atlantia", new CapitalistState(),
                6);
        SolarSystem bSystem = new SolarSystem("Bardic Kingdom", new Monarchy(),
                2);
        SolarSystem cSystem = new SolarSystem("Cyber Alliance", new Cybernetic(),
                7);
        SolarSystem dSystem = new SolarSystem("Disney System", new FacistState(),
                3);
        SolarSystem eSystem = new SolarSystem("Engles Union",
                new CommunistState(), 4);
        SolarSystem fSystem = new SolarSystem("FamCo Ltd", new Corporate(), 5);
        SolarSystem gSystem = new SolarSystem("Golding Barrier Rim",
                new Anarchy(), 0);
        SolarSystem hSystem = new SolarSystem("Hipee Settlements",
                new PacifistState(), 1);
