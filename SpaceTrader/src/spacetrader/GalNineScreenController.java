...
public class GalNineScreenController implements Initializable {
     ...
     * location of plane.
     */
    private static final transient int SOLARSYSTEMNINE = 8;
    /**
     * holds solar system.
     */
    private final transient SolarSystem solar = UNIVERSE.get(SOLARSYSTEMNINE);
    /**
    ...
    */
    ...
    private void goToiPlanet5(final MouseEvent event) throws Exception {
        if (SHIP.getFuel() > 0) {
            ...
            SHIP.setFuel(SHIP.getFuel() - 1);
            PLAYER.setCurrentLocation(solar.getPlanets().get(2 + 2));
    ...
    private String randEvent() {
        ...
        // String string = "";
            ...
            if (val == ((2 ^ 2) ^ 2)) {
                ...
                string = "Your fuel tank "
                        + "has a hole in it and some spilled out!";
                SHIP.setFuel(SHIP.getFuel() - 1);
            } else if (val == (((2 ^ 2) ^ 2) + 1)) {
                ...
                string = "You accidentally "
                        + "did something illegal. Wanted level: "
