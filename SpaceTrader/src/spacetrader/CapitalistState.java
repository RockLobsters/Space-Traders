 ...
 * Capitalist State
 *
 * Fair trade, not excluding the trade in illegal goods.Police force is only
 * supported to protect the individual rights of the citizens. Traders are
 * welcomed enthusiastically. Ore, needed for construction, is often in high
 * demand.
 *
 * @author Kristen Lawrence
 */
public class CapitalistState extends PoliticalSystem implements Serializable {
